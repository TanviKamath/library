...
export default function DomeGallery({
  ...
  const openItemFromElement = useCallback(
    (el, item) => {
      ...
      bookContainer.className = 'book-3d-container';
      ...
      coverFront.className = 'book-cover-front';
      
      const coverOutside = document.createElement('div');
      coverOutside.className = 'book-cover-side book-cover-outside';
      const img = document.createElement('img');
      img.src = rawSrc;
      coverOutside.appendChild(img);

      const coverInside = document.createElement('div');
      coverInside.className = 'book-cover-side book-cover-inside';
      const imgInside = document.createElement('img');
      imgInside.src = rawSrc;
      coverInside.appendChild(imgInside);

      coverFront.appendChild(coverOutside);
      coverFront.appendChild(coverInside);

      bookContainer.appendChild(pageStack);
      bookContainer.appendChild(coverFront);
  ...
  const onTileClick = useCallback(
    (e, item) => {
      ...
      if (openingRef.current) return;
      openItemFromElement(e.currentTarget, item);
    },
    [openItemFromElement]
  );
                ...
                >
                  <img
                    ...
                    onError={(e) => {
                      ...
                      e.target.src = 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?q=80&w=774&auto=format&fit=crop';
                    }}
                  />
                </div>
              </div>
